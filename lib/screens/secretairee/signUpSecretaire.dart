...
import 'loginSecretaire.dart';
class Profile extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return new MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new SignUpSecretaire(),
    );
  }
}


class SignUpSecretaire extends StatefulWidget {
  @override
  _SignUpSecretaireState createState() => new _SignUpSecretaireState();
}


class _SignUpSecretaireState extends State<SignUpSecretaire> {
                              ...
                              child: FlatButton(
                                ...
                                onPressed: (){
                                  if(emailController.text.isEmpty || passwordController.text.isEmpty || firstNameController.text.isEmpty || lastNameController.text.isEmpty) {
                                    ...
                                    AuthSecretaire().addsecretaire(emailController.text,name,passwordController.text).then((val) {
                                      if (val.data['success']) {
                                        var token = val.data['token'];
                                        Fluttertoast.showToast(
                                            msg: 'Inscription Secretaire avec succes',
                                            toastLength: Toast.LENGTH_SHORT,
                                            gravity: ToastGravity.BOTTOM,
                                            timeInSecForIosWeb : 1,
